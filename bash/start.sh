...
command="/home/steam/l4d2/srcds_run -game left4dead2 -port $port +sv_clockcorrection_msecs 20 -timeout 10 -tickrate 100 +map $map -maxplayers 32 +servercfgfile server.cfg"
