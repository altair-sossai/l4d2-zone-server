...
command="/home/steam/l4d2/srcds_run -game left4dead2 -insecure -port $port +sv_clockcorrection_msecs 20 -timeout 10 -tickrate 100 +map $map -maxplayers 32 +servercfgfile server.cfg"

# Start the screen with the command
sudo nice -n -20 screen -d -m -S "$port" $command
